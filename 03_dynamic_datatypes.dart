void main() {
  ...
  errorMessage = 404;
   print("""
    ----------------------------------------------------
    El nuevo valor de errorMessage es: $errorMessage
    En algunos sistemas los errores son controlados por un codigo numérico.
  """);
  ...
  errorMessage = false;
   print("""
    ----------------------------------------------------
    El nuevo valor de errorMessage es: $errorMessage
    Cuando el sistema funciona correctamente el mensaje de error puede ser false.
  """);
  ...
  errorMessage = {125, "Usuario no encotrado", true, -1025.16, "A"};
   print("""
    ----------------------------------------------------
    El nuevo valor de errorMessage es: $errorMessage
  ...
  errorMessage = ()=>true;
   print("""
    ----------------------------------------------------
    El ultimo cambio a error: $errorMessage
